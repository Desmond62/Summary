...
document.getElementById('demo').innerHTML = "1. JavaScript Function: JavaScript Fucntion is a list of instruction that is ready to be executed when being called or involked. ";
document.getElementById('demo1').innerHTML = "2.It is more advisible to place our JavaScript before our closing body tag, because it allows it to load faster and also makes it  easier for any reader to understand,  it speed up our website.";

document.getElementById('demo2').innerHTML =  "3.Variable is a container for storing data.    There are three ways to declare our Variable: Var,Let, Const and declare nothing.....Note:JavaScript have two values, the fixed: which is numbers and strings. Then the Variables: which is Var, Let and Const.";
...
document.getElementById('demo5').innerHTML = "6.JavaScript Comments: Comments are how we comment out our code using // . Note: commenting is good for every programmer, it helps us to save our code for future. remember only u can see it ,the readers can not be able to see our comment";
...
document.getElementById('demo8').innerHTML = "9.Strings deals with alphabet. Typeof strings tells you what you have inside your double quotation and it only accept text. Any other thing apart from text will give you an undefined...Note:when you have number inside your double quotation the result will give you string and not a number";
document.getElementById('demo9').innerHTML = "10.We have keywords in JavaScript; this,funtion,if,let,const,return,try and for etc";
document.getElementById('demo10').innerHTML = "11.We also have JAvaScript Statement are; keyword,value,operators,expression and comments";
...
document.getElementById('demo12').innerHTML = "13.In Reference: we have Object, Array,Function";
